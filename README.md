...
Review common DNS records for one hostname using DNS-over-HTTPS.
...
Open <http://127.0.0.1:8082> in a browser. For CLI-capable tools, run `python3 app.py --help` to see the positional form.
